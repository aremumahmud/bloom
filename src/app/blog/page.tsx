...
export const metadata: Metadata = {
  title: 'The Bloom Home Care Journal | Home Care Insights for Katy, TX Families',
...
const blogSchema = {
  ...
  description: 'Thoughtful insights on home care, aging with dignity, caregiver support, and family resources from Bloom Home Care Home Care in Katy, TX, TX.',
  url: 'https://bloomhomecare.org/blog',
  publisher: {
    '@type': 'Organization',
