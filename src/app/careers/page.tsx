...
export const metadata: Metadata = {
  title: 'Caregiver Jobs in Prosper, Frisco & Katy, TX, TX | Bloom Home Care',
  ...
  openGraph: {
    title: 'Caregiver Jobs in Katy, TX | Bloom Home Care Home Care',
...
const employerSchema = {
  ...
  itemReviewed: {
    ...
    description: 'Compassionate non-medical home care agency serving Katy, TX. Hiring caregivers in Prosper, Frisco, Allen, McKinney, and surrounding areas.',
    address: {
      '@type': 'PostalAddress',
...
export default function Page() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(employerSchema) }} />
