...
export const metadata: Metadata = {
  title: 'Respite Care for Family Caregivers in Katy, TX | Bloom Home Care',
  ...
  openGraph: { title: 'Respite Care for Family Caregivers in Katy, TX | Bloom Home Care', description: 'Scheduled and emergency respite care so family caregivers can rest and recharge across Prosper, Frisco, McKinney, and Allen, TX.', url: 'https://bloomhomecare.org/services/respite-care', type: 'website', siteName: 'Bloom Home Care' },
  twitter: { card: 'summary', title: 'Respite Care in Katy, TX | Bloom Home Care', description: 'Relief for family caregivers in Prosper, Frisco, McKinney, Allen, and Katy, TX.' },
}
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Respite Care',
  description: 'Scheduled and emergency respite care for family caregivers in Katy, TX. Professional care coverage so primary caregivers can rest, travel, or attend to other responsibilities.',
