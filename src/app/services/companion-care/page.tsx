...
export const metadata: Metadata = {
  title: 'Companion Care Services in Katy, TX, TX | Bloom Home Care',
  ...
  openGraph: { title: 'Companion Care in Katy, TX | Bloom Home Care', description: 'Trusted companion care that combats isolation and brings meaningful engagement to seniors and adults across Katy, TX, TX.', url: 'https://bloomhomecare.org/services/companion-care', type: 'website', siteName: 'Bloom Home Care Home Care' },
...
const serviceSchema = {
  ...
  '@type': 'Service',
  name: 'Companion Care',
  description: 'Non-medical companion care providing meaningful conversation, social engagement, and trusted presence for seniors and adults in Katy, TX, TX.',
